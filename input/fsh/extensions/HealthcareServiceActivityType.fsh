...
* valueCodeableConcept from $JDV-J131-CategorieActiviteSanitaireRegulee-RASS (extensible)
* valueCodeableConcept ^binding.description = "JDV_J131-CategorieActiviteSanitaireRegulee-RASS ( dérivée de la TRE_R277-CategorieActiviteSanitaireRegulee.tabs: « urn:oid: 1.2.250.1.213.1.6.1.129»)"