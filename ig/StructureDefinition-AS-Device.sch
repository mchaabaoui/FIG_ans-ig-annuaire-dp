...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Device">
      ...
      <sch:assert test="count(f:extension[@url = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/Device-NumberAuthorizationARHGOS']) &lt;= 1">extension with URL = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/Device-NumberAuthorizationARHGOS': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/Device-AuthorizationDateDevice']) &lt;= 1">extension with URL = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/Device-AuthorizationDateDevice': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/Device-PeriodImplantation']) &lt;= 1">extension with URL = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/Device-PeriodImplantation': maximum cardinality of 'extension' is 1</sch:assert>
