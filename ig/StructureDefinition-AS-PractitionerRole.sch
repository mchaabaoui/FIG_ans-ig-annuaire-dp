...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:PractitionerRole">
      ...
      <sch:assert test="count(f:extension[@url = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/PractitionerRole-EducationLevel']) &lt;= 1">extension with URL = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/PractitionerRole-EducationLevel': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/PractitionerRole-SmartCard']) &lt;= 1">extension with URL = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/PractitionerRole-SmartCard': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/PractitionerRole-PartOf']) &lt;= 0">extension with URL = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/PractitionerRole-PartOf': maximum cardinality of 'extension' is 0</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/MailboxMSS']) &lt;= 1">extension with URL = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/MailboxMSS': maximum cardinality of 'extension' is 1</sch:assert>
