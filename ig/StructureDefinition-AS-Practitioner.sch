...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner">
      ...
      <sch:assert test="count(f:extension[@url = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/Practitioner-Nationality']) &lt;= 0">extension with URL = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/Practitioner-Nationality': maximum cardinality of 'extension' is 0</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/Practitioner-BirthPlace']) &lt;= 0">extension with URL = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/Practitioner-BirthPlace': maximum cardinality of 'extension' is 0</sch:assert>
