...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Organization">
      ...
      <sch:assert test="count(f:extension[@url = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/DigitalCertificate']) &lt;= 0">extension with URL = 'http://interop.esante.gouv.fr/ig/fhir/as03/StructureDefinition/DigitalCertificate': maximum cardinality of 'extension' is 0</sch:assert>
